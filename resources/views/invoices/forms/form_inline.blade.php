...
<div class="form-body">
  <div class="row">
    ...
    <div class="col-md-3">
      {!! Form::select('InvoiceNo', ['' => 'Select Trailer Number']+$invoices, isset($data) ? $data->InvoiceNo : null, array('class'=>'form-control invoices', 'id'=>'InvoiceNo' )) !!}
    </div>
  </div>
  <div class="row">&nbsp;</div>
  <div class="row">
  ...
  <div class="row">
    ...
    <div class="col-md-3">
      {!! Form::button('Add Line Items ', array('class'=>'btn btn-large btn-primary', 'type'=>'button')) !!}
    </div>
  </div>
  <div class="row">&nbsp;</div>
  <div class="row">
