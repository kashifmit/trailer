              ...
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                 <!-- <li><a><i class="fa fa-home"></i> Home <span class="fa fa-chevron-down"></span></a>
                  ...
                  <li><a href="{{url('/home1')}}"><i class="fa fa-edit"></i>Site<!--<span class="fa fa-chevron-down"></span>--></a>
                    <!--<ul class="nav child_menu">
                 ...
                 <!-- <li><a href="{{url('/Site')}}"><i class="fa fa-edit"></i>Site<!--<span class="fa fa-chevron-down"></span>--></a></li>
