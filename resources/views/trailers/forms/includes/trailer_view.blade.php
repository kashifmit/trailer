			...
			<div class="trailer-block">
				...
				<div class="text">
					...
					<div class="form-group">
						...
						<span>{{(isset($data) && !empty($data)) ? App\Helpers\DataArrayHelper::getMakeName($data->ManufacturerId) : null}}</span>                    
						
					</div>
					<div class="form-group">
						{!! Form::label('ModelYear', 'Year', ['class' => 'bold']) !!}
						<span>{{(isset($data) && !empty($data)) ? $data->ModelYear : null}}</span>
					</div>
					<div class="form-group">
						{!! Form::label('ProductId', 'Size', ['class' => 'bold']) !!}
						<span>{{(isset($data) && !empty($data)) ? $data->ProductId : null}}</span>
					</div>
					<div class="form-group">
						{!! Form::label('SiteId', 'Location', ['class' => 'bold']) !!}
						<span>{{(isset($data) && !empty($data)) ? App\Helpers\DataArrayHelper::getSiteName($data->SiteId) : null}}</span>
					</div>
					<div class="form-group">
						{!! Form::label('ConditionStatusId', 'Condition Status', ['class' => 'bold']) !!}
						<span>{{(isset($data) && !empty($data)) ? App\Helpers\DataArrayHelper::getConditionName($data->ConditionStatusId) : null}}</span>
					</div>
					<div class="form-group">
			...
			<div class="trailer-block trailer-block-bg">
				...
				<div class="text">
					...
					<div class="form-group">
						...
						<span>{{(isset($data) && !empty($data)) ? date('m/d/Y', strtotime($data->LastInsepctionDate)) : null}}</span>
					</div>
					<div class="form-group">
			...
			<div class="trailer-block">
				...
				<div class="text">
					<div class="form-group">
						...
						<span>{{(isset($data) && !empty($data)) ? App\Helpers\DataArrayHelper::getTrackingsystemName($data->etrack_id) : null}}</span>
					</div>
					<div class="form-group">
						{!! Form::label('TrackingId', 'Tracking Number', ['class' => 'bold']) !!}
						<span>{{((isset($data) && !empty($data)) && isset($data->equipmentTracking) ) ? $data->equipmentTracking[0]->TrackingId : null}}</span>
					</div>			
				</div>
			</div>
