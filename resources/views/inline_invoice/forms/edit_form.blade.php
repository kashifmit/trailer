...
<div class="form-body">
  ...
  @foreach($arrayData as $key => $value)
    ...
    <div class="col-md-1">
      {!! Form::text('UnitPrice[]', $value1['UnitPrice'], array('class'=>$value.' form-control', 'id'=>'UnitPrice', 'placeholder'=> 'Unit price' )) !!}
    </div>
    <div class="col-md-1">
      {!! Form::text('LaborHoursQty[]', $value1['LaborHoursQty'], array('class'=>$value.' form-control', 'id'=>'LaborHoursQty', 'placeholder'=> 'Labor Hour Quantity' )) !!}
    </div>
    <div class="col-md-2">
      {!! Form::select('FaultReasonCode[]', ['' => 'Select Fault']+$getFaultCode, $value1['FaultReasonCode'], array('class'=>'form-control invoices FaultReasonCode', 'id'=>'FaultReasonCode' )) !!}
    </div>
    <div class="col-md-2">
      {!! Form::select('ResolutionCodeId[]', ['' => 'Select Resolution']+$getResolutionCode, $value1['ResolutionCodeId'], array('class'=>'form-control invoices ResolutionCodeId', 'id'=>'ResolutionCodeId' )) !!}
    </div>
    <div class="col-md-2">
      {!! Form::select('ATACodeId[]', ['' => 'Select Ata']+$getAtaCode, $value1['ATACodeId'], array('class'=>'form-control invoices PartsLaborId', 'id'=>'PartsLaborId' )) !!}
    </div>
    </div>
    <div class="row">&nbsp;</div>
      @else
