...
<div class="form-body">
  ...
  <div class="row">
    ...
    <div class="col-md-3">
      {!! Form::date('Invoice_Date',isset($data) ? date('m/d/Y', strtotime($data['InvoiceDate'])) : null,array('class'=>'form-control date-picker', 'id'=>'InvoiceDate', 'placeholder'=>'Invoice Date', 'disabled' => isset($data) )) !!}
