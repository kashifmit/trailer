                              ...
                              <div class="x_content">
                                ...
                                <div class="col-xs-3">
                                  ...
                                  <ul class="nav nav-tabs tabs-left">
                                    ...
                                    <li><a href="#profile" num="{{$data->TrailerDetailId}}" data-toggle="tab">Maintenance Requests</a>
                                    </li>
                                    <li><a href="#messages" num="{{$data->TrailerDetailId}}" data-toggle="tab">Registration</a>
                                    </li>
                                    <li><a href="#settings" num="{{$data->TrailerDetailId}}" data-toggle="tab">DOT Inspection</a>
                                    </li>
                                    <li><a href="#Ownership" num="{{$data->TrailerDetailId}}" data-toggle="tab">Ownership Details</a>
                                    </li>
                                    <li><a href="#Location" num="{{$data->TrailerDetailId}}" data-toggle="tab">Location</a>
                                    </li>
                                  </ul>
                                </div>
                                ...
                                <div class="col-xs-9">
                                  ...
                                  <div class="tab-content">
                                    ...
                                    <table class="table table-bordered">
                                          ...
                                          <tbody>
                                            <tr>
                                              <th scope="row"><p id="InvoiceNo"></p></th>
                                              <td ><p id="Qty"></p></td>
                                              <td><p id="ServiceDecription"></p></td>
                                              <td><p id="ChargeAmt"></p></td>
                                            </tr>
                                          </tbody>
                                        </table>
                                    </div>
                                    ...
                                    <table class="table table-bordered">
                                          ...
                                          <tbody>
                                          <tr>
                                              <th scope="row"><p id="Make"></p></th>
                                              <td ><p id="PlateNo"></p></td>
                                              <td><p id="Class"></p></td>
                                              <td><p id="ExpireDate"></p></td>
                                              <th><p id="TitleNo"></p></th>
                                              <td ><p id="RegistrationDate"></p></td>
                                              <td><p id="StateAbbreviation"></p></td>
                                              <td><p id="Document"></p></td>
                                              <th><p id="ModelYear"></p></th>
