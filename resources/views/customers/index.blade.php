                ...
                <div class="form-block mb-5">
                    {!! Form::open(array('method' => 'GET', 'route' => 'customer.list', 'class' => 'form', 'files'=>true)) !!}
                        ...
                        <div class="form-group">
                            {!! Form::select('business', ['' => '--All Business--']+$buniness, \Request::get('business') ? \Request::get('business') : null, array('class'=>'form-control selectable-box form-control-radius', 'id'=>'business')) !!}
                        </div>
                        <div class="form-group">Or</div>
                        <div class="form-group">
                            {!! Form::select('SiteId', ['' => '--All Location--']+$sites, \Request::get('SiteId') ? \Request::get('SiteId') : null, array('class'=>'form-control selectable-box form-control-radius', 'id'=>'SiteId')) !!}                        
                        </div>

                        <div class="form-group">
                            {!! Form::select('CustomerID', ['' => '--All Customers--']+$customers, \Request::get('CustomerID') ? \Request::get('CustomerID') : null, array('class'=>'form-control selectable-box form-control-radius', 'id'=>'CustomerID')) !!}
                        </div>
