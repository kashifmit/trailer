                  ...
                  <div class="x_content">
                    ...
                    {{csrf_field()}}
                      ...
                      <div class="form-group" >
                          ...
                          <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="date" id="one" name="LastInsepctionDate" class="form-control"/>
                        </div>
                      </div>
                      <div class="form-group" >
                      ...
                      <div class="form-group" >
                          ...
                          <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="two" name="Make1" class="form-control"/>  
                          </div>
                      </div>
                      <div class="form-group" >
                          ...
                          <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="three" name="Plate1" class="form-control"/>
                          </div>
                      </div>
                      <div class="form-group" >
                          ...
                          <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="four" name="Class1" class="form-control"/>
                          </div>
                      </div>
                      ...
                      <div class="form-group" >
                          ...
                          <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="date" id="five" name="ExpireDate1" class="form-control"/>
                          </div>
                      </div>
                      <div class="form-group" >
                          ...
                          <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="six" name="TitleNo1" class="form-control"/>
                          </div>
                      </div>
                      <div class="form-group" >
                          ...
                          <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="date" id="seven" name="RegistrationDate1" class="form-control"/>
                          </div>
                      </div>
                      <div class="form-group" >
                      ...
                      <div class="form-group" >
                          ...
                          <div class="col-md-6 col-sm-6 col-xs-12">
                                <input type="file" id="file1" name="Document1" class="form-control">
                          </div>
                      </div>
                      ...
                      <div class="form-group" >
                          ...
                          <div class="col-md-6 col-sm-6 col-xs-12">
                                Yes:<input style="margin-left:10px;" type="radio" class="flat" id="yes" name="info1"  value="YES" checked/> 
                                No:<input style="margin-left:10px;" type="radio" class="flat" id="no" name="info1"  value="NO" />
                          </div>
                      </div>
                      <div class="form-group" >
                      <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name"><span class="required"></span>
                      ...
                      <div class="form-group" >
                          ...
                          <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" name="TitleNo" class="form-control"/>
                          </div>
                      </div>
                      <div class="form-group" >
                          <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">RegistrationDate<span class="required">*</span>
                      ...
                      <div class="form-group" >
                          ...
                          <div class="col-md-6 col-sm-6 col-xs-12">
                                <input type="file" id="file2" name="Document" class="form-control">
                          </div>
                      </div>
                      </div>
