        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="index.html" class="site_title"><i class="fa fa-paw"></i> <span>TrailerApp</span></a>
            </div>
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <!--  <li><a><i class="fa fa-home"></i> Home <span class="fa fa-chevron-down"></span></a>
                  ...
                  <li><a><i class="fa fa-home"></i> Equipment <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="{{url('/TrailerDetails')}}">Trailer</a></li>
                      <li><a href="{{url('/TractorDetails')}}">Tractor</a></li>
                    </ul>
                  </li>
                  <!--<li><a href="{{url('/home2')}}"><i class="fa fa-edit"></i>Equipment</a></li>
                   <li><a href="{{url('/Organization')}}"><i class="fa fa-edit"></i>Organization<span class="fa fa-chevron-down"></span></a>-->
                   <!-- <ul class="nav child_menu">
              ...
              <ul class="nav navbar-nav navbar-right">
                <li class="">
                  <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                    <img src='{{url("img/img.jpg")}}' alt="">John Doe
                ...
                <li role="presentation" class="dropdown">
                  ...
                  <ul id="menu1" class="dropdown-menu list-unstyled msg_list" role="menu">
                    <li>
                      <a>
                        <span class="image"><img src='{{url("img/img.jpg")}}' alt="Profile Image" /></span>
                        <span>
